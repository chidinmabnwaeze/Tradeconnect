export const lgasByState: Record<string, string[]> = {
  ...
  Adamawa: [
    "Demsa", "Fufure", "Ganye", "Guyuk", "Gombi", "Girei", "Hong", "Jada",
    "Larmurde", "Madagali", "Maiha", "Mayo Belwa", "Michika", "Mubi North",
  ...
  Oyo: [
    ...
    "Olorunsogo", "Oluyole", "Ona Ara", "Orelope", "Ori Ire", "Oyo",
    "Oyo East", "Saki East", "Saki West", "Surulere",
  ],
  Plateau: [
    "Bokkos", "Barkin Ladi", "Bassa", "Jos East", "Jos North", "Jos South",
    "Kanam", "Kanke", "Langtang South", "Langtang North", "Mangu",
    "Mikang", "Pankshin", "Qua an Pan", "Riyom", "Shendam", "Wase",
  ],
  Rivers: [
    "Port Harcourt", "Obio-Akpor", "Okrika", "Ogu/Bolo", "Eleme", "Tai",
    "Gokana", "Khana", "Oyigbo", "Opobo-Nkoro", "Andoni", "Bonny",
    "Degema", "Asari-Toru", "Akuku-Toru", "Abua-Odual", "Ahoada West",
    "Ahoada East", "Ogba-Egbema-Ndoni", "Emohua", "Ikwerre", "Etche",
    "Omuma",
  ],
  Sokoto: [
...
export const nigerianStates = Object.keys(lgasByState).sort();
