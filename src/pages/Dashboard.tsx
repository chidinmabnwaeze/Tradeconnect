        ...
        <section className="rounded-4xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-4">
            <div className="rounded-3xl bg-global-bg p-4 text-sm">
              <p className="font-semibold text-slate-900">Total paid out</p>
            ...
            <div className="rounded-3xl bg-global-bg p-4 text-sm">
              <p className="font-semibold text-slate-900">Active Farmers</p>
              <p className="mt-3 text-2xl font-semibold">84</p>
              <p className="mt-2 text-success">Earnings for this period</p>
            </div>
          </div>
